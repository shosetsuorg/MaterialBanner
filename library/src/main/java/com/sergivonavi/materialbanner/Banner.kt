...
class Banner @JvmOverloads constructor(
	...
	private var mButtonsContainer: ButtonsContainer? = null
	private var mLeftButton: MaterialButton? = null
	private var mRightButton: MaterialButton? = null
	...
	private fun retrieveAttrs(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
		...
		if (a.hasValue(R.styleable.Banner_messageTextAppearance)) {
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
				mMessageView!!.setTextAppearance(
					a.getResourceId(
		...
		if (a.hasValue(R.styleable.Banner_buttonsTextAppearance)) {
			...
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
				mLeftButton!!.setTextAppearance(textAppearance)
			} else {
				@Suppress("DEPRECATION")
			...
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
				mRightButton!!.setTextAppearance(textAppearance)
			} else {
				@Suppress("DEPRECATION")
				mLeftButton!!.setTextAppearance(context, textAppearance)
			}
	...
	/**
	 * Shows the [Banner] with the animation or/and after the specified delay in milliseconds.
	 *
	 *
	...
	class Builder {
		 ...
		 */
		fun show(): Banner =
			create().also { banner -> banner.show() }
	}
